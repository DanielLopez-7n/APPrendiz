...
class FichasTests(TestCase):
    ...
    def test_creacion_programa(self):
        ...
        print("✅ Prueba 1 superada: El programa se crea correctamente.")
    ...
    def test_creacion_ficha_y_relacion(self):
        ...
        print("✅ Prueba 2 superada: La ficha se amarra perfectamente a su programa.")
    ...
    def test_representacion_string_ficha(self):
        ...
        print("✅ Prueba 3 superada: El formato de lectura de la ficha es correcto.")
    ...
    def test_bloqueo_fichas_duplicadas(self):
        ...
        print("✅ Prueba 4 superada: El sistema prohíbe crear fichas con números repetidos.")
    ...
    def test_eliminacion_cascada_programa(self):
        ...
        print("✅ Prueba 5 superada: La eliminación en cascada mantiene la base de datos limpia.")
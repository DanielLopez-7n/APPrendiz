# Generated by Django 5.2.1 on 2026-01-07 02:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.empresa', verbose_name='Empresa donde realiza prácticas')),
            ],
            options={
                'ordering': ['-numero'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bitacora', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actividades', to='core.bitacora')),
            ],
        ),
    ]
